...
const translations = {
  id: {
    ...
    exp4_title:'Creative Designer — Desain Visual &amp; Konten', exp4_desc:'Merancang konten visual, poster promosi, identitas brand, dan materi marketing menggunakan Canva. Mencakup desain kemeja corporate, konten sosial media, banner digital, dan branding assets untuk kebutuhan perusahaan magang dan project freelance.',
    ...
    pb8_title:'Visual Identity &amp; Branding Assets', pb8_desc:'Pengembangan aset visual identitas brand: kop surat, kartu nama, banner promosi.',
    ...
    vid_badge:'National Campaign', vid1_title:'Iklan Good Day', vid1_desc:'Penampilan saya sebagai talent dalam iklan TV Good Day skala nasional.', vid2_title:'Iklan IndiHome', vid2_desc:'Penampilan saya sebagai talent dalam kampanye digital IndiHome Telkom Indonesia.', vid_watch:'Tonton di Drive',
  ...
  en: {
    ...
    pb8_title:'Visual Identity &amp; Branding Assets', pb8_desc:'Developed brand identity assets: letterhead, business cards, promotional banners.',
    ...
    vid_badge:'National Campaign', vid1_title:'Good Day Commercial', vid1_desc:'My appearance as talent in the nationally broadcast Good Day TV commercial.', vid2_title:'IndiHome Campaign', vid2_desc:'My appearance as talent in the IndiHome digital campaign.', vid_watch:'Watch on Drive',
  ...
  zh: {
    ...
    pb8_title:'视觉识别 &amp; 品牌资产', pb8_desc:'开发品牌识别资产：信笺、名片、宣传横幅。',
    mcb_text:'有意合作？<strong>让我们讨论您的项目！</strong>',
    video_label:'创意视频', video_title:'我的 <span>创意视频</span>', video_intro:'我作为达人出现在全国品牌广告活动中的镜头前经历。',
    vid_badge:'全国活动', vid1_title:'Good Day广告', vid1_desc:'我在Good Day全国电视广告中担任达人的表现。', vid2_title:'IndiHome广告', vid2_desc:'我在IndiHome数字营销活动中担任达人的表现。', vid_watch:'在Drive观看',
  ...
  es: {
    ...
    pb8_title:'Identidad Visual &amp; Activos de Marca', pb8_desc:'Desarrollé activos de identidad de marca: membrete, tarjetas, banners.',
    ...
    vid_badge:'Campaña Nacional', vid1_title:'Anuncio Good Day', vid1_desc:'Mi aparición como talento en el anuncio de TV nacional de Good Day.', vid2_title:'Campaña IndiHome', vid2_desc:'Mi aparición como talento en la campaña digital de IndiHome.', vid_watch:'Ver en Drive',
